...
Prvnímu a druhému výzkumu dominoval přístup kvantitativní -- data byla sbírána nejdříve v~rámci pilotního on-line šetření a následně v~rámci projektu \uv{Život během pandemie} na reprezentativním vzorku. Třetí šetření bylo uchopeno kvalitativně.
...
Možnost sebereportování prozatím užívá jen velmi omezené množství lidí – v~na\-šem drobném šetření na sociálních sítích ho využila jen jedna třetina respondentů. Polovina respondentů o~této možnosti dokonce ani nevěděla. 
...
\pagebreak
\paragraph* {Výsledky odpovědí v~rámci výzkumu \uv{Život během pandemie}.}
...
Jedna ze styčných psychologických teorií popisujících faktory ovlivňující chování je \uv{Teorie plánovaného chování} \cite{Ajzen1985}. Tato teorie byla v~minulosti úspěšně otestována a aplikována na řadu preventivních chování, jako jsou zdravé dietní návyky \cite{Hackman2014}, mytí rukou \cite{Hackman2014} nebo řízení pod vlivem alkoholu \cite{Moan2011}. V~souvislosti s~výzkumem compliance během pandemie covid-19 byla korelace faktorů postulovaných \uv{Teorií plánovaného chování} nalezena například se sociálním distancováním u~hongkongských \cite{Yu2021} a bangladéšských respondentů \cite{Das2021}. 
...
\begin{center}
    ...
    \caption{Graf ukazuje faktory ovlivňují intenci k~určitému chování podle \uv{Teorie plánovaného chování}. Obrázek přeložen z~\cite{Ajzen2018}.}
    \label{fig:graph}
\end{center}
\end{figure}
