\chapter{Vakcinace pohledem matematick\'{y}ch model\r{u}}
...
% 	\caption{Kalibrace modelu M, popisujícího dynamiku epidemie ve středně velkém městě a okolí a inspirovaného Hodonínskou aglomerací \cite{M-techrep2021}. Graf ukazuje kumulativní počet zemřelých díky covid-19 ($D$) v~modelových simulacích (modrá barva, střední hodnota $\pm$ standardní odchylka) ve srovnání se skutečnou situací v~Česku škálovanou na použitou velikost populace v~modelu M (oranžová barva).}
% 	\label{kalibraceM}
% \end{figure}
