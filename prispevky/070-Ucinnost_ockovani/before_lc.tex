...
%	\end{center}
%	\caption{Časová dynamika spalniček v Česku v hypotetickém případě náhlého ukončení očkování, určená modelem (\ref{measles-model1}), doplněným o sezónní a náhodné vlivy \cite{KeelingRohani2008}; $R_0=17$, $\gamma=1/7$, což odpovídá $\beta=2.43$, $\sigma=1/8$, $b=d=1/(70\times365)$.}
%	\label{measles2}
%\end{figure}
