...
Podstatu sporů o covid dobře ilustrují následující obrázky nalezené na sociálních sítích. 
\begin{center}
\begin{tabular}{cc}
...
Oba grafy nepochybně zobrazují tvrdá data - první počty úmrtí a období,
...
Nyní proberme jednotlivá Hillova kriteria.
\begin{enumerate}
...
\caption{Souvislost redukce kontaltů a relativního týdenního přírůstku hlášených nakažených od 23. března 2020 do 26.dubna 2021 (vlevo) a od 28. září 2020 do 26.dubna 2021 (uprostřed), souvislost stupně protiepidemického systému PES a relativního přírůstku nakažených od 23.listopadu do 25. ledna (doba fungování PES, vpravo)  }
...
kontaktů, měřeného longitudinálním sociologickým výzumem \cite{paqcovid} dva týdny předem. 
...
nakažených oproti stupni protiepidomického
